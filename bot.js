...
client.on('ready',async () => {
  sendReady('491517470138433536', `**__ تـم تـشـغـيـل الـبـوت بـنـجـاح , Music 3 Play Bot | Owner Bot : SoM # 1100__**`);
...
client.on('ready', () => {
    client.channels.find(c => c.id === '490246058350477322').join();
});
